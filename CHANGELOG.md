...
- `devDependencies` refreshed: NestJS 11.2.1, `@nestjs/swagger` 11.4.6, ESLint 10.8.1, `typescript-eslint` 8.67.0, Prettier 3.9.6, `ts-jest` 29.4.12, `@types/node` 24.13.3, `@types/supertest` 7. No runtime dependencies exist, so nothing changes for consumers.
